...
const ScatterPlot = React.memo(
  forwardRef(
    (
      { mode, data, viewMode, setHoveredId, hoveredId, setPosition }: Props,
      ref
    ) => {
      ...
      useEffect(() => {
        const chart = () => {
          ...
          function handleMouseEnter(event: any, d: number[]) {
            ...
            // setHoveredId(d[4]);
            const element = event.currentTarget;
            const scatterX = x(d[0]);
            const scatterY = y(d[1]);
            ...
            if (containerRef.current) {
              ...
              if (svgRect) {
                ...
                const transformedX =
                  currentTransform.x + scatterX * currentTransform.k;
                const transformedY =
                  currentTransform.y + scatterY * currentTransform.k;
          ...
          function handleMouseLeave(event: any, d: number[]) {
            setPosition(null);
            setHoveredId(null);
