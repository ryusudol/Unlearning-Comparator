...
class UnlearningFaceGAFTThread(threading.Thread):
    def __init__(
        self,
        request,
        status,
    ...
    def run(self):
        try:
            ...
            self.loop.run_until_complete(self.unlearn_GA_FT_model())
    ...
    async def unlearn_GA_FT_model(self):
        ...
        for epoch in range(self.request.epochs):
            ...
            print(f"GA Loss: {avg_ga_loss:.4f}, FT Loss: {avg_ft_loss:.4f}")
