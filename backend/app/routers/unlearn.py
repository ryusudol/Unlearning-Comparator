...
# @router.post("/unlearn/cifar10/ga")
...
# @router.post("/unlearn/cifar10/rl")
...
# @router.post("/unlearn/cifar10/ft")
...
# @router.post("/unlearn/cifar10/custom")
...
# @router.post("/unlearn/face/custom")
# async def start_unlearning_face_custom(
#     background_tasks: BackgroundTasks,
#     forget_class: int = Form(..., ge=-1, lt=10),
#     weights_file: UploadFile = File(...),
#     base_weights: str = Form("aaaa.pth"),
# ):
#     if status.is_unlearning:
#         raise HTTPException(
#             status_code=400, 
...
#     weights_filename = f"face_weights_{weights_file.filename}"
#     weights_path = os.path.join('uploaded_models', weights_filename)
#     os.makedirs('uploaded_models', exist_ok=True)
...
#     return { "message": "Face Unlearning process started" }
