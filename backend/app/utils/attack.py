...
async def process_attack_metrics(
    ...
    retrain_file = f"data/cifar10/{forget_class}/a00{forget_class}.json"
...
async def process_face_attack_metrics(
        model, 
        data_loader, 
        device, 
        forget_class=5, 
    ...
    # Load the pre-saved retrain distribution from JSON (face-specific path)
